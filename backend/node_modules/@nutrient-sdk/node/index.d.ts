...
import { Session } from '@/models/ContentEditingAPI';
...
type IMeasurementPrecision = ValueOf<typeof MeasurementPrecision>;
...
declare abstract class Action extends InheritableImmutableRecord<ActionProperties> {
...
interface IJavaScriptAction extends ActionProperties {
    script?: string;
}
...
type IBlendMode = ValueOf<typeof BlendMode>;
...
type IMeasurementScaleUnitFrom = ValueOf<typeof MeasurementScaleUnitFrom>;
...
type IMeasurementScaleUnitTo = ValueOf<typeof MeasurementScaleUnitTo>;
...
type ILineCap = ValueOf<typeof LineCap>;
type LineCapsType = {
    start?: ILineCap | null;
    end?: ILineCap | null;
};
...
type IBorderStyle = ValueOf<typeof BorderStyle>;
...
interface InstantJSON extends SerializedJSON {
...
type TileCacheStats = {
  ...
  tileSizeHistogram: Record<number, number>
}

type TileCacheEventType =
  | 'hit'
  | 'miss'
  | 'put'
  | 'evict'
...
type TileCacheDebugHandle = {
  id: string
  getStats: () => TileCacheStats
  getTrace: () => TileCacheEvent[]
  clearTrace: () => void
}

declare global {
  interface Window {
    __PSPDFKIT_TILE_CACHE_DEBUG__?: TileCacheDebugHandle[]
  }
}
...
type NamedCustomAction = 'GoBack' | 'GoForward' | 'GoToPage' | 'Find' | 'Print' | 'Outline' | 'Search' | 'Brightness' | 'ZoomIn' | 'ZoomOut' | 'SaveAs' | 'Info' | 'FullScreen' | 'Close' | 'Quit';
type PageInfoResponse = {
    ...
    additionalActions?: {
        onPageOpen?: CoreActionJSON;
        onPageClose?: CoreActionJSON;
    };
};
type RawPdfBoxes = {
...
interface BaseAnnotationJSON extends ICollaboratorPermissionsOptions {
    v: number;
...
declare namespace Serializers {
    interface ChoiceFormFieldJSON extends BaseFormFieldJSON {
    ...
    interface ListBoxFormFieldJSON extends ChoiceFormFieldJSON {
        type: 'pspdfkit/form-field/listbox';
    }
    type ComboBoxFormFieldJSON = ChoiceFormFieldJSON & DoNotSpellCheckPropertyPair & {
        type: 'pspdfkit/form-field/combobox';
        edit: boolean;
    };
    interface CheckBoxFormFieldJSON extends BaseFormFieldJSON {
        type: 'pspdfkit/form-field/checkbox';
        options: Array<FormOptionJSON>;
        defaultValues: Array<string>;
    }
    interface RadioButtonFormFieldJSON extends BaseFormFieldJSON {
    ...
    interface ButtonFormFieldJSON extends BaseFormFieldJSON {
        type: 'pspdfkit/form-field/button';
        buttonLabel: string | null;
    }
    interface SignatureFormFieldJSON extends BaseFormFieldJSON {
        type: 'pspdfkit/form-field/signature';
    }
    interface UnknownFormFieldJSON extends BaseFormFieldJSON {
        type: 'pspdfkit/form-field/unknown';
    }
    type FormFieldJSON = ListBoxFormFieldJSON | ComboBoxFormFieldJSON | RadioButtonFormFieldJSON | CheckBoxFormFieldJSON | TextFormFieldJSON | ButtonFormFieldJSON | SignatureFormFieldJSON | UnknownFormFieldJSON;
    ...
    interface ImageAnnotationJSON extends Omit<BaseAnnotationJSON, 'type'> {
        type: 'pspdfkit/image';
    ...
    interface ShapeAnnotationJSON extends Omit<BaseAnnotationJSON, 'type'> {
        strokeWidth: number;
    ...
    interface EllipseAnnotationJSON extends ShapeAnnotationJSON {
    ...
    interface LineAnnotationJSON extends ShapeAnnotationJSON {
    ...
    interface PolygonAnnotationJSON extends ShapeAnnotationJSON {
    ...
    interface PolylineAnnotationJSON extends ShapeAnnotationJSON {
    ...
    interface RectangleAnnotationJSON extends ShapeAnnotationJSON {
        type: 'pspdfkit/shape/rectangle';
        cloudyBorderIntensity: number | null;
        cloudyBorderInset?: InsetJSON | null;
        measurementBBox: IRectJSON | null;
    }
    interface InkAnnotationJSON extends BaseAnnotationJSON {
        type: 'pspdfkit/ink';
        lines: {
            points: [number, number][][];
            intensities: number[][];
    ...
    interface LinkAnnotationJSON extends BaseAnnotationJSON {
        type: 'pspdfkit/link';
        borderColor?: string | null;
        borderWidth?: number | null;
        borderStyle?: IBorderStyle | null;
    }
    interface NoteAnnotationJSON extends Omit<BaseAnnotationJSON, 'type'> {
        type: 'pspdfkit/note';
        text?: {
            format: 'plain';
            value: string;
    ...
    interface MediaAnnotationJSON extends Omit<BaseAnnotationJSON, 'type'> {
        type: 'pspdfkit/media';
        description: string | null;
        fileName: string | null;
    ...
    interface TextMarkupAnnotationJSON extends BaseTextMarkupAnnotationJSON {
    ...
    interface RedactionAnnotationJSON extends BaseTextMarkupAnnotationJSON {
    ...
    interface StampAnnotationJSON extends Omit<BaseAnnotationJSON, 'type'> {
        type: 'pspdfkit/stamp';
        stampType: StampKind;
        title: string | null;
        color?: string | null;
    ...
    interface TextAnnotationJSON extends Omit<BaseAnnotationJSON, 'type'> {
        type: 'pspdfkit/text';
        text: {
            format: 'xhtml' | 'plain';
            value: string;
    ...
    interface UnknownAnnotationJSON extends Omit<BaseAnnotationJSON, 'type'> {
        type: 'pspdfkit/unknown';
    }
    interface WidgetAnnotationJSON extends Omit<BaseAnnotationJSON, 'type'> {
    ...
    interface CommentMarkerAnnotationJSON extends Omit<BaseAnnotationJSON, 'type'> {
    ...
    interface CommentJSON extends ICollaboratorPermissionsOptions {
        id?: string | null;
...
declare const loadOptionsSchema: ZodObject<{
    ...
    document: ArrayBuffer | Uint8Array | Buffer;
    fonts?: {
        name: string;
        data: ArrayBuffer | Uint8Array | Buffer;
    }[] | undefined;
